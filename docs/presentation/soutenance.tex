...
\item Time
\begin{itemize}
\item millis() -- Durée d'execution du programme
\item micros() 
\item delay() -- Attente passive
...
\item Flexible products: Add modern high level script-language capabilities to your projects, resulting in highly adaptable, field-programable and reconfigurable designs. Efficient (and cheap!) future evolution to your systems.
\end{itemize}
\end{frame}
